...
description: Resolve GPU detection, ROCm, CUDA, and configuration issues
---

This guide helps resolve "No GPU detected, running on CPU" errors and other common configuration issues.
...
<AccordionGroup>
  <Accordion title="Issue 1: AMD GPU Not Detected (ROCm)">
    ### Symptoms
  ...
  <Accordion title="Issue 2: CPU-Only PyTorch Installed">
    ### Symptoms
    ...
    <Note>
    Check [pytorch.org/get-started](https://pytorch.org/get-started/locally/) for the latest CUDA version supported by PyTorch.
    </Note>
  </Accordion>

  <Accordion title="Issue 3: NVIDIA GPU Not Detected (CUDA)">
    ### Symptoms
  ...
  <Accordion title="Issue 4: WSL2 GPU Access Issues">
    ### Symptoms
    ...
    3. Follow: [docs.nvidia.com/cuda/wsl-user-guide](https://docs.nvidia.com/cuda/wsl-user-guide/index.html)
...
<Tabs>
  ...
  <Tab title="RX 7900 XT/XTX (RDNA3)">
    ```bash
    # Linux/macOS
    export HSA_OVERRIDE_GFX_VERSION=11.0.0
    export MIOPEN_FIND_MODE=FAST
...
<CardGroup cols={2}>
  <Card title="ROCm Linux Setup" icon="linux" href="https://github.com/ace-step/ACE-Step-1.5/blob/main/docs/en/ACE-Step1.5-Rocm-Manual-Linux.md">
    Detailed ROCm installation guide for Linux
  </Card>
  
  <Card title="ROCm Windows Setup" icon="windows" href="https://github.com/ace-step/ACE-Step-1.5/blob/main/requirements-rocm.txt">
    ROCm installation instructions for Windows
  </Card>
  
  <Card title="GPU Compatibility" icon="microchip" href="/configuration/gpu-compatibility">
    GPU tier configuration and VRAM requirements
  </Card>
...
<Warning>
Before opening an issue, please verify you've tried all relevant solutions in this guide for your specific GPU vendor (AMD/NVIDIA).
</Warning>
